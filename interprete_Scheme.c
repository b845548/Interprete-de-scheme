...
int fonction_detecteur(char * inst){
  ...
  if(strstr(inst,"(")==NULL && strstr(inst,"#")!=NULL && strstr(inst,"'(")==NULL && strstr(inst,")")==NULL && strstr(inst,"car")==NULL && strstr(inst,"cdr")==NULL && strstr(inst,"cons")==NULL && strstr(inst,"+")==NULL && strstr(inst,"-")==NULL && strstr(inst,"*")==NULL && strstr(inst,"/")==NULL && strstr(inst,"if")==NULL && strstr(inst,"<")==NULL && strstr(inst,">")==NULL && strstr(inst,"=")==NULL)return 0;
  // caractere #f or #t  

  if(strstr(inst,"(")!=NULL && strstr(inst,"'(")==NULL && strstr(inst,")")!=NULL && strstr(inst,"car")==NULL && strstr(inst,"cdr")==NULL && strstr(inst,"cons")==NULL && strstr(inst,"+")==NULL && strstr(inst,"-")==NULL && strstr(inst,"*")==NULL && strstr(inst,"/")==NULL && strstr(inst,"if")==NULL && strstr(inst,"#")==NULL && ((strstr(inst,"<")!=NULL || strstr(inst,">")!=NULL || strstr(inst,"=")!=NULL)) )return 1;
  // calcul boolean
  if(strstr(inst,"(")==NULL && strstr(inst,"'(")==NULL && strstr(inst,")")==NULL && strstr(inst,"car")==NULL && strstr(inst,"cdr")==NULL && strstr(inst,"cons")==NULL && strstr(inst,"+")==NULL && strstr(inst,"-")==NULL && strstr(inst,"*")==NULL && strstr(inst,"/")==NULL && strstr(inst,"if")==NULL && strstr(inst,"#")==NULL && strstr(inst,"<")==NULL && strstr(inst,">")==NULL && strstr(inst,"=")==NULL )return 2;// une val existe 

  if(strstr(inst,"'(")!=NULL && strstr(inst,"car")==NULL && strstr(inst,"cdr")==NULL&& strstr(inst,"cons")==NULL && strstr(inst,"if")==NULL && strstr(inst,"<")==NULL && strstr(inst,">")==NULL && strstr(inst,"=")==NULL )return 3;//"'(1 2 3 4 5 6 7 8 9)"= liste

  if(strstr(inst,"(")!=NULL && strstr(inst,"'(")==NULL && strstr(inst,")")!=NULL && strstr(inst,"car")==NULL && strstr(inst,"cdr")==NULL && strstr(inst,"cons")==NULL && (strstr(inst,"+")!=NULL || strstr(inst,"-")!=NULL || strstr(inst,"*")!=NULL || strstr(inst,"/")!=NULL ) && strstr(inst,"if")==NULL && strstr(inst,"#")==NULL && strstr(inst,"<")==NULL && strstr(inst,">")==NULL && strstr(inst,"=")==NULL )return 4;

  
  if(strstr(inst,"(")!=NULL && strstr(inst,"'(")!=NULL && strstr(inst,")")!=NULL &&( strstr(inst,"car")!=NULL || strstr(inst,"cdr")!=NULL || strstr(inst,"cons")!=NULL) && strstr(inst,"+")==NULL && strstr(inst,"-")==NULL && strstr(inst,"*")==NULL && strstr(inst,"/")==NULL && strstr(inst,"if")==NULL && strstr(inst,"#")==NULL && strstr(inst,"<")==NULL && strstr(inst,">")==NULL && strstr(inst,"=")==NULL )return 5;// list
...
void main(){
  ...
  char inst6[100]="(if (= 5 4)(+ 1234 5)(+ 5 (+ 5454 5448 54   )  ))";
